...
class User: Codable, Hashable {
    ...
    init(id: String, isActive: Bool = false, name: String = "User", age: Int = 0, company: String = "", email: String = "", address: String = "", about: String = "", registered: String = "", tags: [String] = [], friends: [Friend] = []) {
        self.id = id
